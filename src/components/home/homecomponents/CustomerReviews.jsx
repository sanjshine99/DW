...
const Testimonials = () => {
  ...
  const testimonialsData = [
    ...
    {
      rating: "★★★★★",
      quote: `Absolutely love our Deluxe Caravan! We went with the 21'6 Storm Breaker and we're so happy with it. Such great craftsmanship and the service from Lachlan and the team has been amazing. Highly recommended 😁🙌🏼`,
      author: "Luke Morris"
    },
    {
      rating: "★★★★★",
    ...
    {
      rating: "★★★★★",
      quote: `Very happy with our new 21 stormbreaker. Communication and customer service has been great.The workmanship on the caravan is of high standard and it's very comfortable with plenty of storage space for us to live in as a family travelling full time. HIGHLY RECOMMENDED`,
      author: "Kerryn North"
    },
    {
      rating: "★★★★★",
    ...
    {
      rating: "★★★★★",
      quote: `What an amazing experience this has been. Delux have been so helpful throughout and answered all my questions.  We are off for our first Xmas trip and will definitely update with journey. Thanks Lakshan and crew.`,
      author: "Mel Mclellan"
    }
