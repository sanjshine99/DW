...
const TechspecEclipse22 = () => {
  ...
  const images = useMemo(() => {
    return [
      animatedImage("https://deluxcaravan.b-cdn.net/assets/techspec/kilogram.webp", 'Bespokemodels', 'Tare Approx: 2860kg'),
...
export default React.memo(TechspecEclipse22);
