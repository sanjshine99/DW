...
const Techspec19 = () => {
  ...
  const images = useMemo(() => {
    return [
      animatedImage("https://deluxcaravan.b-cdn.net/assets/techspec/kilogram.webp", 'Bespokemodels', 'Tare Approx: 2700kg'),
      ...
      animatedImage("https://deluxcaravan.b-cdn.net/assets/techspec/length.webp", 'Ratings', 'External Length: 8600mm'),
