    ...
    <div className="container">
      <div className="component">
        <div className="background-image">
          <img src="https://deluxcaravan.b-cdn.net/assets/Product%20renders/SB2311Exterior.webp" alt="" />
      ...
      <div className="component">
        <div className="product-container" id="layout">
          <div className="description">
            <p>
            Got more than 3 kids or always wanted buy a caravan with a spacious living space for your kids. Look
no further than our Stormbreaker 23&#39;11, the solution you&#39;ve been seeking. This model offers all the
remarkable features unique to this family bunk model. A key feature that set this model apart it the
large, separate ensuite at the rear. Built with premium interior, exterior, and mechanical features
when you embark on the open road with your loved ones, you&#39;ll be treated to an exceptionally
roomy layout, complete with all the amenities you&#39;d expect from a luxury RV.
            </p>
